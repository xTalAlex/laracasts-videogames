...
@section('content')
    <div class="container px-4 mx-auto">
            ...
            <div class="lg:ml-12 xl:mr-64">
                ...
                <div class="flex flex-wrap items-center mt-8">
                    ...
                    <div class="flex items-center ml-12">
                        <div id="criticRating" class="relative w-16 h-16 text-sm bg-gray-800 rounded-full">
                            @push('scripts')
                                @include('_rating', [
                                    'slug' => 'criticRating',
        ...
        >
            ...
            <div class="grid gap-12 mt-8 gird-cols-1 md:grid-cols-2 lg:grid-cols-3">
                @foreach ($game['screenshots'] as $screenshot)
                    <div>
                        <a
                            ...
                            "
                        >
                            <img src="{{ $screenshot['big'] }}" alt="screenshot" class="transition duration-150 ease-in-out hover:opacity-75">
                        </a>
                    </div>
                @endforeach
            </div>
        ...
        @if($game['similarGames'] && count($game['similarGames']))
        <div class="mt-8 similar-games-container">
            <h2 class="font-semibold tracking-wide text-blue-500 uppercase">Similar Games</h2>
            <div class="grid grid-cols-1 gap-12 text-sm similar-games md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6">
